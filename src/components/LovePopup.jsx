...
// ─── Fecha de inicio ─────────────────────────────────────────────
const START_DATE = new Date('2025-11-29T22:10:00');

// ─── Equivalencias (cálculos reales) ─────────────────────────────
// Para agregar más, simplemente añadí un objeto { icon, getEquivalence } a este array.
...
const EQUIVALENCES = [
    ...
    {
        icon: '📺',
        // Sex and the City: 47 horas = 2820 minutos
        getEquivalence: (days) => {
